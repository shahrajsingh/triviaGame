...
functions.http("helloHttp", async (req, res) => {
  ...
  corsMiddleware(req, res, async () => {
    try {
      const { category } = req.body; // Extract the category from the HTTP request body

      // Query Firestore to gather all documents from the teamScores collection with the specified category
